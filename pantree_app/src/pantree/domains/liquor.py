...
class Liquor(Domain):
    ...
    def __init__(self, db = ''):
        super(Liquor, self).__init__(domain_prefix='https://www.liquor.com/recipes/',
    ...
    def get_raw_ingredient_strings(self, URL):
        ...
        if results == []:
            results = soup.find_all("li", class_="simple-list__item js-checkbox-trigger ingredient text-passage")
